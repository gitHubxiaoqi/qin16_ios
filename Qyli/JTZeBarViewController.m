...
@interface JTZeBarViewController ()
@end
enum {
    qr_margin = 3
};

@implementation JTZeBarViewController
...
-(void)readyUI
{
    ...
    UIImageView * logoImgView=[[UIImageView alloc] initWithFrame:CGRectMake(10, 20+NAV_HEIGHT+20, SCREEN_WIDTH-20, SCREEN_WIDTH-20)];
    logoImgView.contentMode=UIViewContentModeScaleAspectFit;
    logoImgView.image=[self qrImageForString:[NSString stringWithFormat:@"%@",self.idStr] imageSize:400];
