//
//  JTShangpinDetailViewController.m
//  Qyli
//
...
@interface JTShangpinDetailViewController ()<UIWebViewDelegate,UIAlertViewDelegate>
{
    int p;
...
@implementation JTShangpinDetailViewController
...
-(void)readyUIAgain
{
    ...
    [dianpuBtn addTarget:self action:@selector(dianPu) forControlEvents:UIControlEventTouchUpInside];
    ...
    else if ([self.model.isCanSeal intValue]==0)
    {
        ...
        telImgView.frame=CGRectMake(SCREEN_WIDTH-50, 70, 20, 25);
        chatBtn.hidden=YES;
...
-(void)kaquanBtnClick
{
    ...
    kqVC.shopId=self.model.fuId;
    kqVC.goodsId=self.model.idStr;
...
-(void)dianPu
{
    ...
    {
        //从商品列表，个人商品评价介绍，首页搜索进
        JTDianpuDetailViewController * dianpuVC=[[JTDianpuDetailViewController alloc] init];
        dianpuVC.sortmodel=[[JTSortModel alloc] init];
        dianpuVC.sortmodel.idStr=[NSString stringWithFormat:@"%@",_model.fuId];
...
-(void)sendPost
{
    ...
    if ([SOAPRequest checkNet])
    {
        ...
        NSDictionary * jsondic=[[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%@",self.sortmodel.idStr],@"id",userID,@"userId",[NSString stringWithFormat:@"%@,%@",appDelegate.appLat,appDelegate.appLng],@"location", nil];
        
        NSDictionary * zaojiaoDic=[[NSDictionary alloc] initWithDictionary:[SOAPRequest getResponseByPostURL:[NSString stringWithFormat:@"%s%s",QYL_URL,NEW_QYL_ShangPin_ShopGoods] jsonDic:jsondic]];
 
        if ([[NSString stringWithFormat:@"%@",[zaojiaoDic objectForKey:@"resultCode"]]isEqualToString:@"1000"])
        {
            NSDictionary * resultDic=[[NSDictionary alloc] initWithDictionary:[[zaojiaoDic objectForKey:@"model"] objectForKey:@"goods"]];
            ...
            //_model.cost=[NSString stringWithFormat:@"%@",[resultDic objectForKey:@"price"]];
            _model.score=[resultDic objectForKey:@"score"];
            _model.commentCount=[resultDic objectForKey:@"reviewCount"];
            
        
          _model.fuId=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"id"];
          _model.fuName=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"name"];
         _model.linkman=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"linkman"];
         _model.tel=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"tel"];
        _model.quStr=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"regionName"];
        _model.street=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"streetName"];
        _model.infoAddress=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"address"];

          _model.lat=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"lat"];
          _model.lng=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"lng"];

        _model.distance=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"distance"];
        
       _model.isCanSeal=[[[zaojiaoDic objectForKey:@"model"] objectForKey:@"shop"] objectForKey:@"cooperation"];
