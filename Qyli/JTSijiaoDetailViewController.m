//
//  JTSijiaoDetailViewController.m
//  清一丽
//
...
@interface JTSijiaoDetailViewController ()<UIWebViewDelegate>
{
    int p;
...
@implementation JTSijiaoDetailViewController
...
-(void)readyUIAgain
{
    ...
    [huoDongBtn addTarget:self action:@selector(KeCheng) forControlEvents:UIControlEventTouchUpInside];
...
-(void)GPSBtnClick
{
    if (_model.lat!=nil)
    {
        ...
        mapVC.subTitle=[NSString stringWithFormat:@"%@%@",self.model.quStr,self.model.street];
